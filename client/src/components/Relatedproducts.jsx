...
import NewRelatedProduct from "./NewRelatedProduct";
...
//     <Link
//       to={url}
//       className="group bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 w-full block overflow-hidden"
//     >
...
//             <button
//               className="bg-white p-1.5 rounded-full hover:bg-gray-100 hover:scale-110 transition-all duration-200 shadow-sm"
...
//           {badge && (
//             <p
//               className="text-xs text-gray-400 uppercase tracking-wider mb-1 font-normal"
...
//           {/* Product Name */}
//           <h3
//             className="text-sm font-medium line-clamp-2 mb-2 leading-tight text-gray-900"
//             style={{ fontFamily: "'DM Sans', sans-serif" }}
//           >
//             {title}
//           </h3>
...
//             {originalPrice && (
//               <span
//                 className="text-sm text-gray-400 line-through font-normal"
//                 style={{ fontFamily: "'DM Sans', sans-serif" }}
//               >
//                 ₹{originalPrice}
//               </span>
...
const RelatedProducts = ({ products, themeColor }) => {
  ...
  return (
    ...
    <NewRelatedProduct themeColor={themeColor} products={products} />
  );
};
