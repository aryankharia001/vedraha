...
export default function NabhiHeaderTamil({ onCartOpen, cartCount = 0 }) {
  ...
  // வெளியே கிளிக் செய்தால் dropdown மூடு
  useEffect(() => {
    const handler = (e) => {
        ...
        <div className="nh-inner">
          <a href="#home" className="nh-logo" onClick={(e) => { e.preventDefault(); scrollTo("home"); }}>
            <div className="nh-logo-name">
              <img src="https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=nabhiLogo.webp&version_id=null" alt="நாபி அமிர்த்" style={{ width: "80px", height: "auto" }} />
            </div>
          </a>
          ...
          <div className="nh-modal-right">
            ...
            {submitted ? (
              ...
              <>
                ...
                {/* பதிவு மட்டும்: கடவுச்சொல் உறுதிப்படுத்தல் */}
                {mode === "signup" && (
                  <div className="nh-field">
                ...
                <div className="nh-terms">
                  தொடர்வதன் மூலம் நீங்கள் எங்கள்{" "}
                  <a href="#">தனியுரிமைக் கொள்கை மற்றும் விதிமுறைகளை</a> ஏற்கிறீர்கள்.
                </div>
              </>
            )}
          </div>
      ...
      {menuOpen && (
        <div className="nh-mob-drawer">
          <div className="nh-mob-head">
            <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 17, fontWeight: 700 }}>அக்ரவி</span>
            <button
