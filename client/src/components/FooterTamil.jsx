...
const footerLinks = [
  { heading: 'நிறுவனம்', links: ['எங்களைப் பற்றி', 'வலைப்பதிவுகள்', 'எங்களைத் தொடர்பு கொள்ள', 'வேலைவாய்ப்பு'] },
  { heading: 'வாடிக்கையாளர் சேவை', links: ['எனது கணக்கு', 'ஆர்டரைக் கண்காணிக்க', 'திரும்பப் பெறுதல்', 'அடிக்கடி கேட்கப்படும் கேள்விகள் (FAQ)'] },
  { heading: 'எங்கள் தகவல்', links: ['தனியுரிமைக் கொள்கை', 'பயனர் விதிமுறைகள் மற்றும் நிபந்தனைகள்', 'பொருட்களைத் திரும்பப் பெறும் கொள்கை'] },
];

const contactInfo = {
  heading: 'தொடர்பு விபரம்',
  phone: '+0123-456-789',
  email: 'example@gmail.com',
  address: '8502 பிரஸ்டன் ரோடு, இங்கிள்வுட், மெய்ன் 98380',
};
...
// ─── MAIN FOOTER ──────────────────────────────────────────────────────────────
export default function FooterTamil() {
  return (
      ...
      <div style={{ maxWidth: '1240px', margin: '0 auto', backgroundColor: 'var(--color-white)', borderRadius: 'var(--radius-2xl)', border: '1px solid var(--color-placeholder)', boxShadow: 'var(--shadow-card)', overflow: 'hidden' }}>
        <div className='gap-[2rem] md:gap-[2.5rem]' style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(155px, 1fr))', padding: '2.5rem 2.5rem', position: 'relative' }}>
          <div className='translate-y-[-18px]' style={{ display: 'flex', flexDirection: 'column', gap: '1rem', minWidth: '180px', maxWidth: '240px' }}>
            ...
            <p style={{ color: 'var(--color-muted)', fontSize: '0.8125rem', lineHeight: '1.7', fontFamily: 'var(--font-body)' }}>
              உடல் மற்றும் மன நலத்திற்கான ஆயுர்வேதத்தின் தூய்மை மற்றும் பண்டைய அறிவு. இயற்கையோடு இணைந்த சிறந்த தயாரிப்புகளை உங்களுக்காக நாங்கள் வழங்குகிறோம்.
            </p>
          ...
          <div className='absolute left-0 lg:right-0 bottom-0' style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
            <img src={paymentImg} alt="ஏற்றுக்கொள்ளப்படும் கட்டண முறைகள்" style={{ height: '110px', width: 'auto', objectFit: 'contain', objectPosition: 'right center', display: 'block' }} />
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '16px', padding: '1.125rem 2.5rem' }}>
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8125rem', margin: 0, fontFamily: 'var(--font-body)', flexShrink: 0 }}>
            பதிப்புரிமை © 2026 <a href="#" style={{ color: 'var(--color-gold)', fontWeight: '600', textDecoration: 'none', transition: 'var(--transition-fast)' }} onMouseEnter={e => { e.currentTarget.style.color = 'var(--color-primary)'; }} onMouseLeave={e => { e.currentTarget.style.color = 'var(--color-gold)'; }}>Vedraha</a>. அனைத்து உரிமைகளும் பாதுகாக்கப்பட்டவை.
          </p>
        </div>
      </div>
    </footer>
