      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .nh-logo-tagline {
          ...
          font-size: 10px; color: #888; letter-spacing: 0.04em; margin-top: 1px;
        }
        .nh-nav { display: flex; align-items: center; gap: 2px; }
        .nh-nav a {
          font-size: 13px; font-weight: 600; color: #1a1a1a; text-decoration: none;
          letter-spacing: 0.03em; padding: 8px 14px; border-radius: 6px;
        ...
        .nh-ibtn {
          ...
          color: #1a1a1a; position: relative; transition: background 0.15s;
        }
        ...
        .nh-dropdown {
          ...
          box-shadow: 0 12px 40px rgba(0,0,0,0.14); min-width: 210px;
        ...
        .nh-drop-name { font-size: 14px; font-weight: 700; color: #1a1a1a; margin-bottom: 2px; font-family: 'Tiro Devanagari Hindi', serif; }
        .nh-drop-item {
        ...
        .nh-modal-left-sub {
          font-size: 13px; color: #777; line-height: 1.8; margin-bottom: 28px;
          font-family: 'Tiro Devanagari Hindi', serif;
        }
        .nh-benefit-cards { display: flex; flex-direction: column; gap: 12px; }
        .nh-benefit-card {
          padding: 14px 16px; background: #fff; border-radius: 12px;
          border: 1px solid #e8e4da; display: flex; align-items: flex-start; gap: 12px;
        }
        ...
        .nh-modal-close {
          ...
          border: 1.5px solid #d6d2c8; background: #fff; cursor: pointer;
          display: flex; align-items: center; justify-content: center;
        ...
        .nh-tab {
          flex: 1; padding: 8px 0; font-size: 13px; font-weight: 700; color: #aaa;
        ...
        .nh-pass-toggle {
          ...
          background: none; border: none; cursor: pointer; color: #999; padding: 0; display: flex;
        }
        ...
        .nh-notify-row {
          ...
          font-size: 12.5px; color: #666; cursor: pointer; margin-bottom: 16px;
          font-family: 'Tiro Devanagari Hindi', serif;
        }
        ...
        .nh-switch-mode { font-size: 12.5px; color: #888; text-align: center; font-family: 'Tiro Devanagari Hindi', serif; }
        .nh-switch-mode button {
        ...
        .nh-terms {
          font-size: 11px; color: #999; text-align: center; line-height: 1.6; margin-top: 10px;
          font-family: 'Tiro Devanagari Hindi', serif;
        }
        ...
        .nh-success-icon {
          width: 56px; height: 56px; background: #f0f7ee; border-radius: 50%;
        ...
        .nh-success-sub {
          font-size: 13px; color: #666; line-height: 1.8; margin-bottom: 18px;
          font-family: 'Tiro Devanagari Hindi', serif;
        }
        ...
        .nh-spinner {
          ...
          border-radius: 50%; animation: nhSpin 0.6s linear infinite; flex-shrink: 0;
        }
        ...
        .nh-mob-head {
          padding: 18px 20px; border-bottom: 1px solid #eeebe4;
          display: flex; align-items: center; justify-content: space-between;
        }
        .nh-mob-link {
          display: flex; align-items: center; justify-content: space-between;
          padding: 15px 20px; font-size: 13px; font-weight: 700; color: #1a1a1a;
          letter-spacing: 0.02em; border-bottom: 1px solid #f5f3ef;
              ...
              <>
                ...
                {mode === "signup" && (
                  <div className="nh-field">
                    <label className="nh-label">नाम (वैकल्पिक)</label>
                    <input
                      className="nh-input"
                      type="text"
                ...
                {/* Email */}
                <div className="nh-field">
                  <label className="nh-label">ईमेल</label>
                  <input
                ...
                {/* Password */}
                <div className="nh-field">
                  <label className="nh-label">पासवर्ड</label>
                ...
                {mode === "signup" && (
                  <div className="nh-field">
                    <label className="nh-label">पासवर्ड पुनः दर्ज करें</label>
                    <div className="nh-input-wrap">
                      <input
        ...
        <div className="nh-mob-drawer">
          <div className="nh-mob-head">
            <div>
              ...
              <span style={{ fontFamily: "'Tiro Devanagari Hindi', serif", fontSize: 11, color: "#888", marginLeft: 6 }}>आकृवि</span>
            </div>
            <button
              style={{
          ...
          {loggedInUser ? (
            <>
              <div className="nh-mob-link" onClick={() => { navigate("/my-orders"); setMenuOpen(false); }}>
