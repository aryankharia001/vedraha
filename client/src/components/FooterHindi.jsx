...
const footerLinks = [
  { heading: 'कंपनी', links: ['हमारे बारे में', 'ब्लॉग', 'संपर्क करें', 'करियर'] },
  { heading: 'ग्राहक सेवा', links: ['मेरा खाता', 'ऑर्डर ट्रैक करें', 'वापसी (रिटर्न)', 'अक्सर पूछे जाने वाले प्रश्न (FAQ)'] },
  { heading: 'हमारी जानकारी', links: ['गोपनीयता नीति', 'उपयोगकर्ता नियम और शर्तें', 'वापसी नीति'] },
];
...
const contactInfo = {
  ...
  address: '8502 प्रेस्टन रोड, इंगलवुड, मेन 98380',
};
      ...
      <div style={{ maxWidth: '1240px', margin: '0 auto', backgroundColor: 'var(--color-white)', borderRadius: 'var(--radius-2xl)', border: '1px solid var(--color-placeholder)', boxShadow: 'var(--shadow-card)', overflow: 'hidden' }}>
        <div className='gap-[2rem] md:gap-[2.5rem]' style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(155px, 1fr))', padding: '2.5rem 2.5rem', position: 'relative' }}>
          <div className='translate-y-[-18px]' style={{ display: 'flex', flexDirection: 'column', gap: '1rem', minWidth: '180px', maxWidth: '240px' }}>
            ...
            <p style={{ color: 'var(--color-muted)', fontSize: '0.8125rem', lineHeight: '1.7', fontFamily: 'var(--font-body)' }}>
              शारीरिक और मानसिक कल्याण के लिए आयुर्वेद की शुद्धता और प्राचीन ज्ञान। हम आपके लिए सीधे प्रकृति से जुड़े बेहतरीन उत्पाद लाते हैं।
            </p>
          ...
          <div className='absolute left-0 lg:right-0 bottom-0' style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
            <img src={paymentImg} alt="स्वीकार किए जाने वाले भुगतान के तरीके" style={{ height: '110px', width: 'auto', objectFit: 'contain', objectPosition: 'right center', display: 'block' }} />
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '16px', padding: '1.125rem 2.5rem' }}>
          <p style={{ color: 'var(--color-muted)', fontSize: '0.8125rem', margin: 0, fontFamily: 'var(--font-body)', flexShrink: 0 }}>
            कॉपीराइट © 2026 <a href="#" style={{ color: 'var(--color-gold)', fontWeight: '600', textDecoration: 'none', transition: 'var(--transition-fast)' }} onMouseEnter={e => { e.currentTarget.style.color = 'var(--color-primary)'; }} onMouseLeave={e => { e.currentTarget.style.color = 'var(--color-gold)'; }}>Vedraha</a>. सभी अधिकार सुरक्षित हैं।
          </p>
        </div>
      </div>
    </footer>
