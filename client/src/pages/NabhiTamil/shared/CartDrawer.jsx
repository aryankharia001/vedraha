      ...
      >
        ...
        {cartItems.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-14 text-center">
            ...
            <div
              className="text-2xl font-bold text-gray-900 mb-2.5"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
          ...
          <>
            <div className="flex-1 overflow-y-auto px-6">
              {cartItems.map((item) => (
                <div
                  key={item.cartId}
                  className="flex gap-3.5 py-4 border-b border-gray-100"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-[#2d5a27] font-semibold mb-2">
                      {item.variantLabel}
                    </div>
                    ...
                    <div className="flex items-center gap-1.5">
                      <button
                        ...
                        className={`w-7 h-7 rounded-md border border-gray-200 bg-white cursor-pointer flex items-center justify-center ${
                          item.quantity === 1
                            ? "text-gray-300"
                            : "text-gray-900"
                        }`}
                  ...
                  <div className="flex flex-col items-end justify-between flex-shrink-0">
                    ...
                    >
                      ₹
                      {(
                        item.variantPriceNum * item.quantity
                      ).toLocaleString("en-IN")}
                    </div>

                    <div className="text-xs text-gray-300">
                      ₹{item.variantPriceNum.toLocaleString("en-IN")} ஒரு பாட்டில்
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div className="pt-4 pb-1 flex justify-between items-center">
                ...
                <span
                  className="text-2xl font-extrabold text-[#2d5a27]"
                  style={{ fontFamily: "'DM Sans', sans-serif" }}
                >
              ...
              <div className="text-xs text-gray-400 pb-4">
                இலவச டெலிவரி · ஆன்லைன் அல்லது கேஷ் ஆன் டெலிவரி
              </div>
            </div>
            ...
            <div className="px-6 pt-3 pb-7 border-t border-gray-100 flex-shrink-0">
              ...
              <p className="text-center text-xs text-gray-300 mt-2.5">
                UPI · கார்டு · நெட் பேங்கிங் · COD — அனைத்து விருப்பங்களும் அடுத்த படியில்
              </p>
            </div>
          </>
        )}
