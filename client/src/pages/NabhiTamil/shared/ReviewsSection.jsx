                  ...
                  <div className="flex justify-between items-start mb-1 gap-2">
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        <MdVerified size={14} color="#2d5a27" title="Verified Purchase" />
                      </div>
                    </div>
    ...
    <div id="reviews" className="bg-white">
      <div className="max-w-[1100px] mx-auto px-5">
        <div className="py-13 pb-8">
          <h2 className="text-center text-3xl font-bold mb-6 tracking-tight leading-tight" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Customer Reviews
          </h2>
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-200 flex items-center gap-7 mb-7 flex-wrap">
            <div className="text-center min-w-[100px]">
              ...
              <div className="text-xs text-gray-300 mt-1.5">Based on customer reviews</div>
            </div>
