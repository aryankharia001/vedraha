...
const Colon = () => (
  <span
    className="text-xl font-black pb-5"
...
const ProductCard = ({ product }) => {
  ...
  const totalSecs = product.hasCountdown
    ? product.countdown.days * 86400 +
      product.countdown.hours * 3600 +
            ...
            <div className="flex items-end justify-center gap-1.5">
              {[
                ...
                <React.Fragment key={unit.l}>
                  ...
                  {i < arr.length - 1 && (
                    <span className="text-white/60 font-bold pb-4 text-sm">
                      :
                    </span>
                  )}
                </React.Fragment>
      ...
      <div className="flex flex-col flex-1 px-4 pt-3.5 pb-4 gap-2">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <span
            ...
            style={{ color: "var(--color-price-active)" }}
          >
  ...
  return (
    <div className="relative rounded-3xl overflow-hidden mt-10 flex items-stretch min-h-[260px] gap-5">
      <div className="hidden sm:block w-[26%] flex-none relative rounded-3xl overflow-hidden bg-[var(--color-cream)]">
        <img
          src="https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=shilajitcare3.webp&version_id=null"
          alt="Promo left"
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent 60%, var(--color-cream) 100%)",
          }}
        />
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-12 z-10 relative rounded-3xl overflow-hidden bg-[var(--color-cream)]">
        ...
        <h3
          ...
          style={{ fontFamily: "var(--font-new-1)",
              color: "var(--color-heading)", letterSpacing: "-0.02em" }}
        >
          {content.heading}
          <span style={{ fontFamily: "var(--font-new-2)",fontStyle:"italic",fontWeight:"500",
      ...
      <div className="hidden sm:block w-[26%] flex-none relative rounded-3xl overflow-hidden bg-[var(--color-cream)]">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to left, transparent 60%, var(--color-cream) 100%)",
          }}
        />
      </div>
    </div>
    ...
    >
      <div className="max-w-[1240px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="flex flex-col items-center text-center mb-14">
          ...
          >
            Our Best Sellers{" "}
            <em style={{ color: "var(--color-blue)",fontFamily: "var(--font-new-2)", fontStyle: "italic",fontWeight:"500" }}>
