...
const promoCards = [
  {
    ...
    headingSuffix: " Deals",
    description:
      "Nourish and strengthen your hair with our premium range of treatments.",
    ctaLabel: "Shop Now",
    ctaHref: "#",
    image:
  ...
  },
  {
    ...
    headingSuffix: "",
    description:
      "Glow every day with our curated skincare bundles at unbeatable prices.",
    ctaLabel: "Shop Now",
    ctaHref: "#",
    image:
...
const CategoryCard = ({ title, image, href }) => (
  ...
  >
    ...
    <p className="text-base font-semibold text-[#111827] tracking-tight">
      {title}
    </p>
  </a>
);
