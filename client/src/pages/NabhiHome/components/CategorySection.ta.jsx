...
const sectionContent = {
  subtitle: 'எங்கள் வகைகள்',
  headingPrefix: 'வகையின்படி ',
  headingHighlight: 'காண்க',
}
...
const promoCards = [
  {
    id: 'hair-promo',
    badge: '25% தள்ளுபடி',
    headingPrefix: 'சிறப்பு ',
    headingHighlight: 'ஹேர் கேர்',
    headingSuffix: ' சலுகைகள்',
    description: 'பிரீமியம் சிகிச்சை வரம்பில் உங்கள் தலைமுடியை போषித்து வலுவாக்குங்கள்.',
    ctaLabel: 'வாங்குங்கள்',
    ctaHref: '#',
    image: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?auto=format&fit=crop&w=500&q=80',
    imageAlt: 'ஆரோக்கியமான முடி கொண்ட பெண்',
  ...
  },
  {
    id: 'skin-promo',
    badge: '20% தள்ளுபடி',
    headingPrefix: 'ஸ்கின்கேரில் ',
    headingHighlight: 'பெரிய சேமிப்பு',
    headingSuffix: '',
    description: 'வசதியான விலைகளில் CURATED ஸ்கின்கேர் பங்குகளுடன் தினமும் மின்னுங்கள்.',
    ctaLabel: 'வாங்குங்கள்',
    ctaHref: '#',
    image: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&w=500&q=80',
    imageAlt: 'முகம்முகை அணிந்த பெண்',
    ...
    <section className="bg-white py-20">
      <div className="max-w-[1240px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center gap-2 mt-6" role="tablist" aria-label="கேரஸல் வழிசெலுத்தல்">
            {scrollSnaps.map((_, idx) => (
              <button
                ...
                aria-label={`ஸ்லைடு ${idx + 1}க்கு செல்லுங்கள்`}
              />
            ))}
          </div>
        </div>
