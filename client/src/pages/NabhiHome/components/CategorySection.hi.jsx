...
const sectionContent = {
  subtitle: 'हमारी श्रेणियाँ',
  headingPrefix: 'श्रेणी के अनुसार ',
  headingHighlight: 'खरीदें',
}
...
const promoCards = [
  {
    ...
    badge: '25% की छूट',
    headingPrefix: 'विशेष ',
    headingHighlight: 'हेयर केयर',
    headingSuffix: ' ऑफर',
    description: 'प्रीमियम ट्रीटमेंट रेंज से अपने बालों को पोषित और मजबूत करें।',
    ctaLabel: 'खरीदें',
    ctaHref: '#',
    image: 'https://images.unsplash.com/photo-1487412947147-5cebf100ffc2?auto=format&fit=crop&w=500&q=80',
    imageAlt: 'स्वस्थ बालों वाली महिला',
  ...
  },
  {
    id: 'skin-promo',
    badge: '20% की छूट',
    headingPrefix: 'स्किनकेयर पर ',
    headingHighlight: 'बड़ी बचत',
    headingSuffix: '',
    description: 'असाधारण कीमतों परCURATED स्किनकेयर बंडल के साथ रोज़ाना चमकें।',
    ctaLabel: 'खरीदें',
    ctaHref: '#',
    image: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&w=500&q=80',
    imageAlt: 'फेस मास्क लगाई महिला',
    ...
    <section className="bg-white py-20">
      <div className="max-w-[1240px] mx-auto px-4 md:px-8 lg:px-12">
        ...
        <div className="mb-16">
          ...
          <div className="flex justify-center gap-2 mt-6" role="tablist" aria-label="कैरोसेल नेविगेशन">
            {scrollSnaps.map((_, idx) => (
              <button
                ...
                aria-label={`स्लाइड ${idx + 1} पर जाएं`}
              />
            ))}
          </div>
        </div>
