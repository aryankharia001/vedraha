...
const slides = [
  {
    eyebrow: 'आत्मविश्वास के साथ चमकें, विश्वास के साथ खरीदें',
    title: 'आपका अंतिम',
    highlight: 'ब्यूटी और कॉस्मेटिक्स हब',
    description:
      'सौंदर्य उत्पादों की विस्तृत श्रृंखला खोजें - प्रीमियम स्किनकेयर, मेकअप, हेयरकेयर और फ्रैग्रेंस।',
    image:
  ...
  {
    eyebrow: 'ताज़ी देखभाल, प्राकृतिक चमक',
    title: 'प्रीमियम स्किन',
    highlight: 'केयर एसेंशियल्स',
    description:
      'कोमल दिनचर्या, ताज़ी फॉर्मूले और रोज़मर्रा की आवश्यक वस्तुएं जो आत्मविश्वासी चमक देती हैं।',
    image:
  ...
  {
    eyebrow: 'विश्वसनीय उत्पाद, तेज़ डिलीवरी',
    title: 'आधुनिक मेकअप',
    highlight: 'हर दिन के लिए',
    description:
      'सुरक्षित चेकआउट और आसान डिलीवरी के साथ ब्यूटी फेवरेट्स, कॉस्मेटिक्स और सेल्फ-केयर खरीदें।',
    image:
...
const marqueeItems = ['स्किन केयर', 'मेकअप', 'हेयर केयर', 'फ्रैग्रेंस', 'नेल केयर', 'बॉडी केयर']
