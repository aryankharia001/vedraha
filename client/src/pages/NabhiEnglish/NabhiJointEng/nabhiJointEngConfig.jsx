...
const variants = [
  {
    ...
    mrp: 649,
    badge: null,
    externalVariantId: 477155402648532032,
  },
  {
    id: 2,
    ...
    mrp: 1299,
    badge: "Save ₹300",
    externalVariantId: 477155416070304832,
  },
];
...
const bloatSection = {
  ...
  body1:
    "Morning stiffness in knees, hips, and the lower back is one of the most common complaints for people over 40. Joint Pain Remedy Nabhi Oil works overnight — apply before bed so the herbs absorb deeply during rest.",
  body2:
    "With regular use, many customers report waking up with significantly less stiffness.",
  imageSrc:
    "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=Gemini_Generated_Image_jejzeajejzeajejz.png.webp&version_id=null",
};
...
const balanceSection = {
  ...
  body1:
    "In Ayurveda, the <strong>navel</strong> is the body's primary energy center, connected to thousands of subtle channels that influence joint health, inflammation levels, and overall vitality.",
  body2:
    "By nourishing the navel with this specially formulated Ayurvedic oil, you help restore internal balance.",
  videoSrc: false,
  imageSrc:
    "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=Gemini_Generated_Image_3y48f93y48f93y48.png.webp&version_id=null",
};
...
const ritualSection = {
  ...
  subtitle:
    "Rooted in ancient Ayurvedic wisdom — the navel center is connected to every joint and organ through thousands of energy channels.",
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#2d5a27" />,
      title: "Powerful Herbal Blend",
      desc: "Infused with Ajwain, Asafoetida, Ginger, and other Ayurvedic herbs — slow-cooked to extract full therapeutic potency for joint health.",
    },
    {
      icon: <GiMeditation size={22} color="#2d5a27" />,
      title: "Navel Energy Center",
      desc: "The navel is the body's primary energy hub connected to thousands of nerves. Navel therapy delivers herbal benefits through this powerful center.",
    },
    {
      icon: <GiDroplets size={22} color="#2d5a27" />,
      title: "Deep Transdermal Absorption",
      desc: "The navel area is rich in nerve endings and micro blood vessels. Oils applied here are absorbed rapidly into the body.",
    },
    {
      icon: <GiHealing size={22} color="#2d5a27" />,
      title: "Restores Joint Balance",
      desc: "Helps naturally reduce inflammation and promotes better flexibility with regular nightly use.",
    },
  ],
};
...
const whyUsSection = {
  ...
  items: [
    {
      icon: <GiKneeBandage size={28} color="#2d5a27" />,
      title: "Joint Pain & Stiffness Relief",
      desc: "Reaches the root of joint discomfort through the navel's energy channels — naturally eases stiffness in knees, back, and hips.",
    },
    {
      icon: <FaLeaf size={26} color="#2d5a27" />,
      title: "100% Ayurvedic Herbs",
      desc: "Made with Ajwain, Asafoetida, Ginger, and other time-tested herbs — free from chemicals, parabens, and mineral oils.",
    },
    {
      icon: <HiSparkles size={26} color="#2d5a27" />,
      title: "Reduces Inflammation",
      desc: "Soothing herbal blend helps calm inflammation and irritation around joints.",
    },
    {
      icon: <FaLeaf size={26} color="#2d5a27" />,
      title: "Simple Nightly Ritual",
      desc: "Just 2–3 drops into the navel before bed — no hassle. An easy Ayurvedic routine that works while you rest.",
    },
  ],
};
  ...
  items: [
    {
      ...
      name: "Ramesh Gupta",
      rating: 5,
      body: "Been using it for 3 weeks. Morning knee stiffness has reduced significantly.",
      date: "03/12/2026",
      image: null,
      likes: 4,
    },
    {
      ...
      name: "Sunita Verma",
      rating: 5,
      body: "I suffered from back pain for years. Applying this oil on the navel has given me clear relief.",
      date: "02/28/2026",
      image: null,
      likes: 6,
    },
    {
      ...
      name: "Arun Mishra",
      rating: 4,
      body: "The herbal formulation feels genuine. Joints feel more flexible after 2 weeks of use.",
      date: "03/18/2026",
      image: null,
      likes: 3,
    },
    {
      ...
      name: "Fatima Ansari",
      rating: 5,
      body: "My mother has arthritis. She applied this and says the swelling in her fingers has reduced.",
      date: "01/30/2026",
      image: null,
      likes: 7,
    },
    {
      ...
      name: "Deepak Sharma",
      rating: 5,
      body: "Just a few drops before bed. Wake up feeling lighter, without joint stiffness.",
      date: "02/15/2026",
      image: null,
      likes: 5,
    },
    {
      ...
      name: "Preeti Nair",
      rating: 4,
      body: "Genuine herbal scent. Feel warmth after applying — very comforting.",
      date: "03/05/2026",
      image: null,
      likes: 2,
    },
