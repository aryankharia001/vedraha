...
const variants = [
  {
    ...
    mrp: 769,
    badge: null,
    externalVariantId: 477247394800564160,
  },
  {
    id: 2,
    label: "Buy 2 Jars – ₹300 Off",
    price: "₹1,099",
    priceNum: 1099,
    mrp: 1399,
    badge: "Save ₹300",
    externalVariantId: 477247412248868800,
  },
];
...
const bloatSection = {
  ...
  body1:
    "Fatigue, weakness, and low stamina are increasingly common in today's fast-paced life.",
  body2:
    "Shilajit strengthens the body from within and provides sustained natural energy.",
  imageSrc: images[1],
};
...
const balanceSection = {
  ...
  body1:
    "Shilajit is a natural substance that seeps from Himalayan rocks over centuries.",
  body2:
    "It helps revitalise the body, restore vitality, and support long-term wellness.",
  imageSrc: images[0],
};
...
const ritualSection = {
  ...
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#3b2f2f" />,
      title: "Rich in Minerals",
      desc: "Contains 85+ essential trace minerals",
    },
    {
      icon: <GiMeditation size={22} color="#3b2f2f" />,
      title: "Boosts Energy",
      desc: "Increases stamina and strength naturally",
    },
    {
      icon: <GiDroplets size={22} color="#3b2f2f" />,
      title: "Fast Absorption",
      desc: "Rapidly absorbed and utilised by the body",
    },
    {
      icon: <GiHealing size={22} color="#3b2f2f" />,
      title: "Recovery Support",
      desc: "Reduces fatigue and combats weakness",
    },
  ],
};
...
const whyUsSection = {
  ...
  items: [
    {
      icon: <FaLeaf size={26} color="#3b2f2f" />,
      title: "100% Pure",
      desc: "No adulterants, no fillers",
    },
    {
      icon: <HiSparkles size={26} color="#3b2f2f" />,
      title: "Energy Booster",
      desc: "Sustains energy levels throughout the day",
    },
    {
      icon: <FaLeaf size={26} color="#3b2f2f" />,
      title: "Easy to Use",
      desc: "Simply mix with milk or water",
    },
  ],
};
  ...
  items: [
    {
      ...
      name: "Amit Singh",
      rating: 5,
      body: "My energy levels have shot up. Feel much more active throughout the day.",
      date: "02/20/2026",
    },
    {
      id: 2,
      name: "Vikas Yadav",
      rating: 5,
      body: "Stamina has improved noticeably. Great product, highly recommended.",
      date: "01/30/2026",
    },
  ],
};
