...
const variants = [
  {
    ...
    mrp: 599,
    badge: null,
    externalVariantId: 477155790806201408,
  },
  {
    id: 2,
    ...
    mrp: 1199,
    badge: "Save ₹300",
    externalVariantId: 477155804764845120,
  },
];
...
const bloatSection = {
  ...
  body1:
    "Hair fall, weak roots and dull hair are often signs of poor internal nourishment.",
  body2:
    "Hair Care Nabhi Oil works overnight, delivering herbs deep into your system while you rest.",
  imageSrc: images[2],
};
...
const balanceSection = {
  ...
  body1:
    "In Ayurveda, the navel is connected to the body's sensory and nutritive network.",
  body2:
    "Herbs applied through the navel channel their nourishing effect all the way to hair roots.",
  imageSrc: images[0],
};
...
const ritualSection = {
  ...
  subtitle:
    "The navel is the body's energy center, connected to hair roots and scalp health",
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#2d5a27" />,
      title: "Herbal Blend",
      desc: "A powerful formula made from Bhringraj, Amla, and Hibiscus",
    },
    {
    ...
    },
    {
      ...
      desc: "Reduces hair fall and promotes healthy growth",
    },
  ],
};
  ...
  items: [
    {
      ...
      desc: "100% natural ingredients, no chemicals",
    },
    {
      icon: <HiSparkles size={26} color="#2d5a27" />,
      title: "Reduces Hair Fall",
      desc: "Strengthens roots from inside out",
    },
    {
      icon: <FaLeaf size={26} color="#2d5a27" />,
      title: "Nighttime Use",
      desc: "Simple 2-drop routine before bed",
    },
  ],
};
  ...
  items: [
    {
      ...
      name: "Ritu Sharma",
      rating: 5,
      body: "My hair fall reduced noticeably within 3 weeks.",
      date: "02/10/2026",
    },
    {
      id: 2,
      name: "Arjun Mehta",
      rating: 5,
      body: "Very good product, hair feels stronger and shinier.",
      date: "01/22/2026",
    },
  ],
};
