      ...
      >
        ...
        {cartItems.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-14 text-center">
            ...
            <div className="text-sm text-gray-400 leading-relaxed mb-7">Add a product to get started</div>
            <button
              onClick={onClose}
          ...
          <>
            <div className="flex-1 overflow-y-auto px-6">
              {cartItems.map((item) => (
                <div key={item.cartId} className="flex gap-3.5 py-4 border-b border-gray-100">
                  ...
                  <div className="flex flex-col items-end justify-between flex-shrink-0">
                    ...
                    <div className="text-xs text-gray-300">₹{item.variantPriceNum.toLocaleString("en-IN")} per bottle</div>
                  </div>
                </div>
              ))}
              ...
              <div className="text-xs text-gray-400 pb-4">Free shipping · Online or Cash on Delivery</div>
            </div>
            ...
            <div className="px-6 pt-3 pb-7 border-t border-gray-100 flex-shrink-0">
              ...
              >
                ...
                <span className="text-base font-extrabold text-white tracking-wide">
                  Buy Now · ₹{totalAmt.toLocaleString("en-IN")}
                </span>
              </button>
              <p className="text-center text-xs text-gray-300 mt-2.5">
                UPI · Card · Net Banking · COD — all options in the next step
              </p>
            </div>
          </>
        )}
