...
export default function ProductGallery({ images = [], themeColor = "#2d5a27", onPauseChange }) {
  ...
  return (
    ...
    >
      ...
      {/* Thumbnails */}
      <div className="flex xl:flex-col xl:absolute xl:z-50 inset-0 xl:left-[-15%] xl:top-[50%] xl:translate-y-[-50%] gap-2 mt-2.5 overflow-x-auto pb-1 scrollbar-none md:h-fit">
        {images.map((img, i) => {
          const isVideo = typeof img === "object" && img.type === "video";
