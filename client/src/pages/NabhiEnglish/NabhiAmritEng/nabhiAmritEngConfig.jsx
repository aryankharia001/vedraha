...
const product = {
  ...
  h1: "Digestion and Detox",
  reviewSummary: "4.62 · 189 Verified Reviews",
  paymentImage:
    "https://console.minio.traffakpay.com/api/v1/buckets/vedraha/objects/download?preview=true&prefix=allpayment.png&version_id=null",
...
const variants = [
  {
    ...
    mrp: 599,
    badge: null,
    externalVariantId: 477155136897430592,
  },
  {
    id: 2,
    label: "Buy 2 Bottles",
    ...
    mrp: 999,
    badge: "Save ₹300",
    externalVariantId: 477155162130363456,
  },
  {
    id: 3,
    label: "Buy 3 Bottles",
    ...
    mrp: 1499,
    badge: "Save ₹500",
    externalVariantId: 477155176089007168,
  },
];
...
const images = [
  "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=3e_V1.jpg&version_id=null",
  {
    ...
    poster:
      "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=Screenshot%202026-04-30%20at%205.44.14%E2%80%AFPM-optimized.webp&version_id=null",
  },
...
const bloatSection = {
  ...
  body1:
    "Helps reduce uncomfortable bloating by supporting the body's natural digestive balance.",
  body2:
    "With regular use, your stomach can feel lighter, flatter, and more comfortable throughout the day.",
  videoSrc:
    "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=nabhi.mp4&version_id=null",
};

const balanceSection = {
  title: "Balance Flows from the Navel",
  body1:
    "In Ayurveda, the <strong>navel</strong> is considered the center of the body's inner balance and energy flow.",
  body2:
    "By nourishing the navel with Nabhi Amrit, you support the body's natural harmony.",
  videoSrc:
    "https://console.minio.traffakpay.com/api/v1/buckets/akravi/objects/download?preview=true&prefix=amrit.mp4&version_id=null",
};
...
const ritualSection = {
  ...
  subtitle:
    "Rooted in ancient Ayurvedic wisdom, the navel is the body's center connecting thousands of energy channels.",
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#2d5a27" />,
      title: "Traditional Herbal Extracts",
      desc: "Prepared through a slow Ayurvedic extraction process.",
    },
    {
      icon: <GiMeditation size={22} color="#2d5a27" />,
      title: "Manipura Chakra Balancing",
      desc: "The navel is the center of the Manipura Chakra — the energy hub of the body's vitality and inner balance.",
    },
    {
      icon: <GiDroplets size={22} color="#2d5a27" />,
      title: "Deep Navel Absorption",
      desc: "The navel area contains many nerve endings.",
    },
    {
      icon: <GiHealing size={22} color="#2d5a27" />,
      title: "Restores Internal Balance",
      desc: "Supports natural detoxification and helps reduce bloating.",
    },
  ],
};
...
const whyUsSection = {
  title: "Why Choose Us?",
  subtitle:
    "Trusted by over 10,000 customers across India, crafted from nature's finest ingredients.",
  items: [
    {
      icon: <GiDroplets size={28} color="#2d5a27" />,
      title: "Deep Navel Therapy",
      desc: "Specially made for navel application, with deep absorption through the ancient Pechoti method.",
    },
    {
      icon: <FaLeaf size={26} color="#2d5a27" />,
      title: "100% Ayurvedic",
      desc: "Made with time-tested Ayurvedic herbs, free from chemicals and parabens.",
    },
    {
      icon: <HiSparkles size={26} color="#2d5a27" />,
      title: "Holistic Wellness",
      desc: "Supports digestion, joints, hormonal balance, and overall vitality.",
    },
    {
      icon: <FaHandSparkles size={26} color="#2d5a27" />,
      title: "Simple & Safe Routine",
      desc: "Just 2-3 drops at bedtime — no massage, no hassle.",
    },
  ],
};
...
const reviews = {
  items: [
    {
      ...
      name: "Menal Shah",
      rating: 5,
      body: "Very easy to use. Noticed a difference within a week.",
      date: "02/07/2026",
      image: "/NabhiReviewImg/abhi.jpg",
      likes: 3,
    },
    {
      id: 2,
      name: "Harish Iyer",
      rating: 5,
      body: "Its fragrance is very mild and soothing.",
      date: "01/19/2026",
      image: null,
      likes: 2,
    },
    {
      ...
      name: "Ayesha Noor",
      rating: 4,
      body: "A good addition to my wellness routine. Skin feels softer.",
      date: "03/02/2026",
      image: null,
      likes: 4,
    },
    {
      ...
      rating: 5,
      body: "Skin started feeling clearer in 10-12 days and energy is better too.",
      date: "04/10/2026",
      image: "",
      likes: 4,
    },
    {
      ...
      name: "Nitin Bansal",
      rating: 5,
      body: "A great traditional Ayurvedic remedy that works well for digestion.",
      date: "12/28/2025",
      image: null,
      likes: 1,
    },
    {
      ...
      name: "Imran Khan",
      rating: 5,
      body: "It has become part of my daily routine, skin feels soft.",
      date: "02/14/2026",
      image: null,
      likes: 5,
    },
    {
      ...
      name: "Samar Das",
      rating: 4,
      body: "Very simple routine, just apply 2 drops.",
      date: "04/01/2026",
      image: "/NabhiReviewImg/b1.jpg",
      likes: 1,
    },
    {
      id: 6,
      name: "Priya Sharma",
      rating: 5,
      body: "Body truly feels much lighter and skin is looking a bit clearer too.",
      date: "03/21/2026",
      image: "/NabhiReviewImg/g2.jpg",
      likes: 2,
    },
    {
      id: 9,
      name: "Suhani Banerjee",
      rating: 5,
      body: "I apply it on the navel morning and evening; it has become an easy part of my routine.",
      date: "04/15/2026",
      image: "/NabhiReviewImg/g1.jpg",
      likes: 1,
    },
  ],
  photos: [
  ...
  photoReviewers: [
    ...
    },
    {
      ...
      initials: "SB",
      rating: 5,
      body: "Clear skin in 10 days, energy improved",
      likes: 1,
      date: "04/15/2026",
    },
    {
