...
const product = {
  ...
  h1: "Reduce Stress & Enjoy Deep Sleep",
...
const variants = [
  {
    ...
    mrp: 699,
    badge: null,
    externalVariantId: 477155614444106816,
  },
  {
    id: 2,
    ...
    mrp: 1349,
    badge: "Save ₹300",
    externalVariantId: 477155630281798720,
  },
];
...
const bloatSection = {
  ...
  body1:
    "Lack of sleep and stress have become increasingly common in modern life.",
  body2:
    "This navel oil calms both body and mind, helping you sleep better every night.",
  imageSrc: images[1],
};
...
const balanceSection = {
  ...
  body1:
    "According to Ayurveda, the navel is a vital energy center of the body.",
  body2:
    "This oil works through the navel to bring deep relaxation to your entire system.",
  imageSrc: images[0],
};
...
const ritualSection = {
  ...
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#2c3e50" />,
      title: "Herbal Ingredients",
      desc: "Made from pure natural elements",
    },
    {
      icon: <GiMeditation size={22} color="#2c3e50" />,
      title: "Mental Calm",
      desc: "Quiets and soothes the mind",
    },
    {
      icon: <GiNightSleep size={22} color="#2c3e50" />,
      title: "Deep Sleep",
      desc: "Helps you achieve deeper sleep",
    },
    {
      icon: <GiHealing size={22} color="#2c3e50" />,
      title: "Rest & Recovery",
      desc: "Reduces stress and fatigue",
    },
  ],
};
...
const whyUsSection = {
  ...
  items: [
    {
      icon: <FaLeaf size={26} color="#2c3e50" />,
      title: "100% Natural",
      desc: "No chemicals, no artificial additives",
    },
    {
      icon: <HiSparkles size={26} color="#2c3e50" />,
      title: "Better Sleep",
      desc: "Improves sleep quality noticeably",
    },
    {
      icon: <FaLeaf size={26} color="#2c3e50" />,
      title: "Easy to Use",
      desc: "Simply apply at night before bed",
    },
  ],
};
  ...
  items: [
    {
      ...
      name: "Rahul Sharma",
      rating: 5,
      body: "My sleep has improved so much. Fall asleep faster and wake up refreshed.",
      date: "03/10/2026",
    },
    {
      id: 2,
      name: "Neha Verma",
      rating: 5,
      body: "Stress has reduced noticeably and I feel much more rested in the morning.",
      date: "02/25/2026",
    },
  ],
};
