...
const variants = [
  {
    ...
    mrp: 699,
    badge: null,
    externalVariantId: 477247968715569088,
  },
  {
    id: 2,
    ...
    mrp: 1398,
    badge: "Save ₹300",
    externalVariantId: 477247976768632768,
  },
];
...
const bloatSection = {
  ...
  body1:
    "Cramps, bloating, and pain can significantly affect daily life during your cycle.",
  body2:
    "This oil delivers relief from within through navel therapy — naturally and gently.",
  imageSrc: images[1],
};
...
const balanceSection = {
  ...
  body1:
    "The navel is connected to 72,000+ nerves that influence reproductive health.",
  body2:
    "Oil absorption through the navel helps support hormonal balance and eases discomfort.",
  imageSrc: images[0],
};
...
const ritualSection = {
  ...
  items: [
    {
      icon: <GiHerbsBundle size={22} color="#8e3b5b" />,
      title: "Herbal Blend",
      desc: "A special formula crafted for women's wellness",
    },
    {
      icon: <GiMeditation size={22} color="#8e3b5b" />,
      title: "Energy Center",
      desc: "The navel is the body's main energy hub",
    },
    {
      icon: <GiDroplets size={22} color="#8e3b5b" />,
      title: "Absorption",
      desc: "Oil enters the body through the nerve network",
    },
    {
      icon: <GiHealing size={22} color="#8e3b5b" />,
      title: "Relief",
      desc: "Reduces pain and discomfort naturally",
    },
  ],
};
...
const whyUsSection = {
  ...
  items: [
    {
      icon: <FaLeaf size={26} color="#8e3b5b" />,
      title: "100% Natural",
      desc: "No chemicals, no artificial additives",
    },
    {
      icon: <HiSparkles size={26} color="#8e3b5b" />,
      title: "Hormonal Support",
      desc: "Promotes natural balance during your cycle",
    },
    {
      icon: <FaLeaf size={26} color="#8e3b5b" />,
      title: "Easy to Use",
      desc: "Just 2–3 drops at night",
    },
  ],
};
  ...
  items: [
    {
      ...
      rating: 5,
      body: "Got significant relief from pain. My periods feel much more manageable now.",
      date: "02/18/2026",
    },
    {
      id: 2,
      name: "Anushka Verma",
      rating: 5,
      body: "Periods have become easier. I feel less bloated and the cramps are milder.",
      date: "01/29/2026",
    },
  ],
};
