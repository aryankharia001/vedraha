    ...
    <>
      ...
      >
        ...
        <div className="px-6 pt-5 pb-4 flex items-center gap-2.5 border-b border-gray-100 flex-shrink-0">
          ...
          <h3 className="text-xl font-bold text-gray-900 m-0" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>
            आपका कार्ट
          </h3>
          {totalQty > 0 && (
        ...
        {cartItems.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center px-6 py-14 text-center">
            ...
            <div className="text-sm text-gray-400 leading-relaxed mb-7">शुरू करने के लिए एक उत्पाद जोड़ें</div>
            <button
              onClick={onClose}
              ...
              {cartItems.map((item) => (
                <div key={item.cartId} className="flex gap-3.5 py-4 border-b border-gray-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-bold text-gray-900 mb-0.5" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>
                      {item.productName}
                    </div>
                  ...
                  <div className="flex flex-col items-end justify-between flex-shrink-0">
                    ...
                    <div className="text-xs text-gray-300">₹{item.variantPriceNum.toLocaleString("en-IN")} प्रति बोतल</div>
                  </div>
                </div>
              ))}
              <div className="pt-4 pb-1 flex justify-between items-center">
                <span className="text-base text-gray-700 font-semibold">कुल</span>
                <span className="text-2xl font-extrabold text-[#2d5a27]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                  ₹{totalAmt.toLocaleString("en-IN")}
                </span>
              </div>
              <div className="text-xs text-gray-400 pb-4">मुफ्त शिपिंग · ऑनलाइन या कैश ऑन डिलीवरी</div>
            </div>
            ...
            <div className="px-6 pt-3 pb-7 border-t border-gray-100 flex-shrink-0">
              ...
              >
                ...
                <span className="text-base font-extrabold text-white tracking-wide">
                  अभी खरीदें · ₹{totalAmt.toLocaleString("en-IN")}
                </span>
              </button>
              <p className="text-center text-xs text-gray-300 mt-2.5">
                UPI · कार्ड · नेट बैंकिंग · COD — सभी विकल्प अगले चरण में
              </p>
            </div>
          </>
        )}
