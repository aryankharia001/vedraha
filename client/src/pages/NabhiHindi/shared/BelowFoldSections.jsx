/**
 * BelowFoldSections.jsx  — shared/BelowFoldSections.jsx
 *
    ...
    <div className="bg-[#f5f4ef]">
      <div className="max-w-[1100px] mx-auto px-5">
        <div className="py-13 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-4 leading-tight tracking-tight" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>{data.title}</h2>
...
export function OilBenefitsSection({ isMobile, images, title = "एक उत्पाद, अनेक फायदे" }) {
  if (!images?.length) return null;
  return (
    ...
    <div className="max-w-[1100px] mx-auto px-5">
      <div className="py-13 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="rounded-2xl overflow-hidden border border-gray-200 relative bg-[#f5f4ef]" style={{ aspectRatio: "16/20" }}>
          {/* <video ref={vRef} src={data.videoSrc} autoPlay loop muted={muted} playsInline className="w-full h-auto block" style={{ objectFit: "fill" }} /> */}
  ...
  return (
    <div className="bg-black text-white py-13 px-5 text-center">
      <div className="max-w-[1100px] mx-auto">
        <h2 className="text-4xl font-bold mb-3.5 tracking-tight" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>{data.title}</h2>
...
export function RitualFeaturesSection({ data }) {
  ...
  return (
    <div id="ritual" className="bg-white">
      <div className="max-w-[1100px] mx-auto px-5">
        <div className="py-13">
          <h2 className="text-center text-3xl font-bold mb-2.5 tracking-tight leading-tight" style={{ fontFamily: "'Noto Sans Devanagari', sans-serif" }}>{data.title}</h2>
